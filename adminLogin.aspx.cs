...
namespace Mokoena_27268217_Assessment2
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        string conStr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=\\143.160.81.13\CTX_Redirected_Data$\27268217\Documents\Mokoena_27268217_Assessment2\App_Data\adminDb.mdf;Integrated Security=True";
        SqlConnection conn;
        SqlCommand cmd;
        ...
        public void checkPassword()
        {
            try
            {
                ...
                string sql = $"SELECT Password FROM AdminInfo WHERE Username = '{usernameTxtBox.Text}'";
                ...
                if (password == PasswordTxtBox.Text)
                {
                    ...
                    Response.Redirect("adminWorkPage.aspx");
                }
                else
                {
                    // inform the user if the 
                    lblOutput.Text = "Password is incorrect";
                }
        ...
        {
            // declaration of the sql query string
            string checkQuery = $"SELECT count(*) FROM AdminInfo WHERE Username = '{usernameTxtBox.Text}'";
            ...
            else
            {
                ...
                lblOutput.Text = "Username does not exits";
            }
        }
    }
}